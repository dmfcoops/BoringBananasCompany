  ...
  return (
    <div id="bodyy" className="flex flex-col items-center justify-center min-h-screen py-2">
      <Head>
        ...
        <meta property="og:description" content="Here at the Pandimensional Trading CO., we specialise in the world's finest Pandimensional beings." key="ogdesc" />
        <meta property="og:type" content="website" key="ogtype" />
        <meta property="og:url" content="https://pandimensionals.co/" key="ogurl"/>
        <meta property="og:image" content="https://pandimensionals.co/images/Hola.gif" key="ogimage"/>
        <meta property="og:site_name" content="https://pandimensionals.co/" key="ogsitename" />

        <meta name="twitter:card" content="summary_large_image" key="twcard"/>
        <meta property="twitter:domain" content="pandimensionals.co" key="twdomain" />
        <meta property="twitter:url" content="https://pandimensionals.co/" key="twurl" />
        <meta name="twitter:title" content="Pandimensionals Co." key="twtitle" />
        <meta name="twitter:description" content="Here at boring Pandimensionals company, we specialise in the world's finest digital Pandimensionals" key="twdesc" />
        <meta name="twitter:image" content="https://pandimensionals.co/images/Hola.gif" key="twimage" />
      </Head>


      <div >
          <div className="flex items-center justify-between w-full border-b-2	pb-6">
            <a href="/" className=""><img src="images/0.png" width="108" alt="" className="logo-image" /></a>
            <nav className="flex flex-wrap flex-row justify-around Poppitandfinchsans">
              ...
              <a href="https://twitter.com/pandimensionalsco" className="text-4xl  hover:text-white m-6 text-blau">TWITTER</a>
          ...
          <div className="mt-6 border-b-2 py-6">
            <div className="flex flex-wrap lg:flex-nowrap justify-around items-center">
                  <div className="lg:w-1/2 w-3/4">
                    <h1 className="text-7xl Poppitandfinchsans text-white ">EVERYONE, meet <br/><span className="text-blau">Pandimensionals</span></h1>
                    <p className="text-2xl text-white my-6  montserrat">Here at <span className="text-blau text-5xl Poppitandfinchsans">PTCo.</span>, we specialize in the world's <span className="text-span-2 font-bold">cutest Pandimensionals</span>.<br />‍<br />
                    </p>
                    <p className="text-2xl text-white my-6  montserrat">
                    <strong>LAUNCH DATE:</strong> 29 Jan 2022. 2pm GMT. <br />‍
                    <span className="text-white text-2xl montserrat"><strong>TOTAL SUPPLY: 5</strong> Pandimensionals.<br/><strong>PRICE: 0.025 ETH </strong>each.</span></p>
                  ...
                  <img className="lg:w-1/2 w-3/4" src="images/1.png" width="500px" />
            </div>
            ...
            <a href="/mint" className="mt-4 Poppitandfinchsans text-4xl border-6 bg-blau  text-white hover:text-black p-2 ">GO TO MINTING PAGE!</a>
                ...
                <div id="traits" className="flex flex-wrap justify-around items-center  mx-6 py-6">
                  <div className="border-4 border-blue-300 p-4"><img src="images/3.png" alt="" width="400px" className="feature-image"/></div>
                  <div className="flex flex-col justify-between mx-6 sm:w-1/2 w-4/5 py-6 ">
                    <h2 className="text-blau Poppitandfinchsans text-6xl text-center">PANDIMENSIONAL VARIETIES</h2>
                    <p className="text-xl text-white my-6  montserrat"> Following the recent worldwide pandemic, <span className="font-bold"> emerging reports </span>  suggest that several <span className="font-bold"> Pandimensional species </span> have begun exhibiting <span className="font-bold"> strange characteristics. </span> Our research team located across the globe has commenced efforts to <span className="font-bold"> study and document </span>  these unusual phenomena.   
                    </p>
                    ...
                    <p className="text-xl text-white my-6  montserrat"> The fate of the world's Pandimensionals depends on it.
                    </p>
                ...
                <div id="gallery" className="   mx-6 py-6">
                    <h2 className="text-blau Poppitandfinchsans text-7xl text-center">PHANACKAPAN SERIES GALLERY</h2>
                  <div className="flex flex-wrap  items-center mx-6   py-6 ">
                    ...
                    <div className="md:w-1/2 flex flex-wrap">
                      ...
                      <div className=" p-2 w-1/2"><img src="images/0.png" alt="" width="400px" className="feature-image"/></div>
              ...
              <div id="team" className="mx-12 my-16 ">
                <h2 className="text-7xl text-center Poppitandfinchsans text-blau my-4">PTCO RESEARCH TEAM</h2>
              ...
              <div id="contact" className="flex flex-wrap justify-around items-center  mx-6 py-6">
                  ...
                  <div className="flex flex-col justify-between mx-6 sm:w-1/2 w-4/5 py-6 ">
                    <h2 className="text-blau Poppitandfinchsans text-6xl text-center">CONTACT PTCO RESEARCH TEAM</h2>
                    <p className="text-xl text-white my-6  montserrat"> We'd love to hear from you! 
                    </p>
                    <p className="text-xl text-white my-6  montserrat"> Drop us a line at <a className="text-black underline font-bold" target="_blank" href="mailto:pandimensionals69@gmail.com">pandimensionals69@gmail.com</a>,<br/>
                    or alternatively reach out to us on Twitter <a className="text-black underline font-bold" target="_blank" href="https://twitter.com/pandimensionalsco">@BoringPandimensionalsCo</a><br/> 
